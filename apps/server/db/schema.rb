...
ActiveRecord::Schema[7.1].define(version: 2025_01_25_161925) do
  ...
  create_table "auth_codes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["public_id"], name: "index_auth_codes_on_public_id", unique: true
  end
  ...
  create_table "project_members", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_project_members_on_public_id", unique: true
    t.index ["user_id", "project_id"], name: "index_project_members_on_user_id_and_project_id", unique: true, where: "(discarded_at IS NULL)"
  ...
  add_foreign_key "articles", "project_members", column: "member_id"
